...
Current candidate:
`0.1.0-player-cards-preview-p1-r1-20260909-local`.
...
`0.1.0-player-cards-preview-p1-20260909-local`; remote gates для r1 ещё не
...
```bash
export TII_RELEASE_ID="0.1.0-player-cards-preview-p1-r1-20260909-local"
